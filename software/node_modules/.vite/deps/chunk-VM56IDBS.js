...
async function u(i, t, s) {
  ...
  return typeof i == "string" ? e2.path = i : (e2.path = i.path, e2.contents = i.contents), typeof t == "string" ? e2.contents = t != null ? t : "" : r = t, a({ __tauriModule: "Fs", message: { cmd: "writeFile", path: e2.path, contents: Array.from(new TextEncoder().encode(e2.contents)), options: r } });
}
async function f(i, t, s) {
  typeof s == "object" && Object.freeze(s), typeof i == "object" && Object.freeze(i);
  let e2 = { path: "", contents: [] }, r = s;
  return typeof i == "string" ? e2.path = i : (e2.path = i.path, e2.contents = i.contents), t && "dir" in t ? r = t : typeof i == "string" && (e2.contents = t != null ? t : []), a({ __tauriModule: "Fs", message: { cmd: "writeFile", path: e2.path, contents: Array.from(e2.contents instanceof ArrayBuffer ? new Uint8Array(e2.contents) : e2.contents), options: r } });
}
...
//# sourceMappingURL=chunk-VM56IDBS.js.map
